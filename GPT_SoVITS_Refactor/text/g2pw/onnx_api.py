...
import GPT_SoVITS_Refactor.resources.pretrained_models.resources
...
def download_and_decompress(model_dir: str='G2PWModel/'):
    if not os.path.exists(model_dir):
        ...
        zip_dir = os.path.join(os.path.dirname(__file__),"G2PWModel_1.1.zip")
...
class G2PWOnnxConverter:
    def __init__(self,
        ...
        self.model_source = resources.pretrained_models.resources.BERT_PATH
        # self.model_source = "D:\PythonCode\GPT-SoVITS-v2-240821\GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large"
