...
from ..resources.pretrained_models import resources
...
class TTS_Config:
    default_configs = {
        "default": {
            ...
            "is_half": False,
            "version": "v1",
            "t2s_weights_path": resources.GPT_LIST[0],
            # "t2s_weights_path": "GPT_SoVITS/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt",
            "vits_weights_path": resources.SOVITS_LIST[0],
            # "vits_weights_path": "GPT_SoVITS/pretrained_models/s2G488k.pth",
            "cnhuhbert_base_path": resources.CNHUBERT_PATH,
            # "cnhuhbert_base_path": "GPT_SoVITS/pretrained_models/chinese-hubert-base",
            "bert_base_path": resources.BERT_PATH,
            # "bert_base_path": "GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
        },
        "default_v2": {
            "device": "cuda",
            "is_half": False,
            "version": "v2",
            "t2s_weights_path": resources.GPT_LIST[1],
            "vits_weights_path": resources.SOVITS_LIST[1],
            "cnhuhbert_base_path": resources.CNHUBERT_PATH,
            "bert_base_path": resources.BERT_PATH,
        },
    }
    ...
    def __init__(self, configs: Union[dict, str] = None):
        ...
        # 设置默认配置文件路径
        configs_base_path: str = config.CURRENT_DIR
